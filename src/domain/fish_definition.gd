...
static func all_planned() -> Array[FishDefinition]:
	return [make("pumpkinseed", "Pumpkinseed", "willow_pond", 3.4, 12.0, 25.0, 0.28, 2.0, [{"duration": 24, "amplitude": 0.28}, {"duration": 30, "amplitude": 0.38, "gap": 0.10}], 0.72, [0.40, 0.95, 0.08, 0.14, 0.62, 0.25, 1.4, 1.1, 0.8]), make("black_crappie", "Black Crappie", "willow_pond", 2.8, 18.0, 36.0, 0.38, 2.4, [{"duration": 28, "amplitude": 0.42}, {"duration": 28, "amplitude": 0.42, "gap": 0.08}, {"duration": 28, "amplitude": 0.42, "gap": 0.08}], 0.84, [0.56, 0.80, 0.12, 0.18, 0.55, 0.29, 1.1, 1.5, 0.7]), make("brown_bullhead", "Brown Bullhead", "willow_pond", 2.2, 24.0, 44.0, 0.47, 2.8, [{"duration": 90, "amplitude": 0.48}], 1.35, [0.72, 0.70, 0.14, 0.22, 0.48, 0.34, 1.0, 0.9, 1.35]), bluegill(), make("largemouth_bass", "Largemouth Bass", "pine_lake", 2.1, 28.0, 61.0, 0.58, 2.9, [{"duration": 92, "amplitude": 0.78}, {"duration": 36, "amplitude": 0.45, "gap": 0.18}], 1.15, [1.20, 0.70, 0.18, 0.28, 0.40, 0.31, 1.35, 1.20, 0.80]), make("channel_catfish", "Channel Catfish", "pine_lake", 1.2, 32.0, 76.0, 0.70, 3.4, [{"duration": 140, "amplitude": 0.68}], 1.80, [1.55, 0.45, 0.16, 0.31, 0.30, 0.52, 0.65, 0.95, 1.55]), make("rainbow_trout", "Rainbow Trout", "cedar_river", 3.6, 23.0, 53.0, 0.46, 2.1, [{"duration": 30, "amplitude": 0.48}, {"duration": 30, "amplitude": 0.48, "gap": 0.09}, {"duration": 30, "amplitude": 0.48, "gap": 0.09}], 0.90, [0.42, 0.62, 0.20, 0.23, 0.60, 0.30, 1.45, 1.15, 0.65]), make("smallmouth_bass", "Smallmouth Bass", "cedar_river", 2.2, 24.0, 52.0, 0.63, 2.6, [{"duration": 58, "amplitude": 0.82}, {"duration": 86, "amplitude": 0.50, "gap": 0.15}], 1.05, [0.86, 0.62, 0.20, 0.29, 0.44, 0.31, 0.80, 1.30, 1.10]), make("northern_pike", "Northern Pike", "cedar_river", 0.9, 46.0, 103.0, 0.88, 3.7, [{"duration": 150, "amplitude": 1.0}, {"duration": 55, "amplitude": 0.72, "gap": 0.16}], 0.72, [1.05, 0.48, 0.30, 0.39, 0.34, 0.72, 0.35, 0.85, 1.80]), make("red_drum", "Red Drum", "hatteras_inlet", 2.5, 40.0, 86.0, 0.82, 3.0, [{"duration": 120, "amplitude": 0.92}, {"duration": 70, "amplitude": 0.70, "gap": 0.16}], 1.10, [1.10, 0.55, 0.28, 0.36, 0.36, 0.58, 0.9, 1.2, 1.35]), make("spotted_seatrout", "Spotted Seatrout", "hatteras_inlet", 3.0, 28.0, 58.0, 0.60, 2.2, [{"duration": 24, "amplitude": 0.58}, {"duration": 24, "amplitude": 0.58, "gap": 0.07}], 0.68, [0.50, 0.68, 0.20, 0.26, 0.52, 0.36, 1.25, 1.1, 0.85]), make("bluefish", "Bluefish", "hatteras_inlet", 2.1, 35.0, 74.0, 0.76, 2.5, [{"duration": 36, "amplitude": 0.86}, {"duration": 36, "amplitude": 0.86, "gap": 0.06}, {"duration": 36, "amplitude": 0.86, "gap": 0.06}], 0.58, [0.90, 0.42, 0.32, 0.38, 0.34, 0.62, 1.0, 1.2, 1.15]), make("common_snook", "Common Snook", "mangrove_flats", 3.2, 38.0, 98.0, 0.78, 3.0, [{"duration": 72, "amplitude": 0.82}, {"duration": 42, "amplitude": 0.62, "gap": 0.12}], 0.88, [1.15, 0.46, 0.27, 0.35, 0.38, 0.56, 1.6, 1.2, 0.7]), make("mangrove_snapper", "Mangrove Snapper", "mangrove_flats", 3.8, 20.0, 48.0, 0.54, 2.3, [{"duration": 28, "amplitude": 0.56}, {"duration": 28, "amplitude": 0.56, "gap": 0.07}], 0.66, [0.54, 0.72, 0.18, 0.24, 0.54, 0.34, 1.45, 1.05, 0.8]), make("atlantic_tarpon", "Atlantic Tarpon", "mangrove_flats", 0.75, 76.0, 180.0, 0.84, 4.0, [{"duration": 165, "amplitude": 1.0}, {"duration": 90, "amplitude": 0.84, "gap": 0.18}], 1.45, [1.08, 0.54, 0.28, 0.34, 0.38, 0.65, 0.55, 1.0, 1.65]), make("bowfin", "Bowfin", "cypress_bayou", 2.6, 35.0, 78.0, 0.72, 3.1, [{"duration": 88, "amplitude": 0.75}, {"duration": 42, "amplitude": 0.55, "gap": 0.13}], 1.18, [0.92, 0.61, 0.24, 0.31, 0.43, 0.48, 1.35, 0.95, 0.85]), make("longnose_gar", "Longnose Gar", "cypress_bayou", 1.7, 65.0, 145.0, 0.83, 3.6, [{"duration": 122, "amplitude": 0.85}, {"duration": 54, "amplitude": 0.64, "gap": 0.18}], 1.36, [1.30, 0.50, 0.30, 0.37, 0.34, 0.61, 0.65, 1.1, 1.45]), make("flathead_catfish", "Flathead Catfish", "cypress_bayou", 1.0, 56.0, 128.0, 0.90, 4.1, [{"duration": 170, "amplitude": 0.88}], 1.92, [1.66, 0.62, 0.31, 0.40, 0.29, 0.67, 0.55, 0.85, 1.55]), make("walleye", "Walleye", "moonlit_reservoir", 3.1, 30.0, 76.0, 0.60, 2.8, [{"duration": 42, "amplitude": 0.60}, {"duration": 42, "amplitude": 0.60, "gap": 0.12}], 0.96, [0.66, 0.83, 0.19, 0.27, 0.49, 0.39, 1.05, 1.35, 0.9]), make("striped_bass", "Striped Bass", "moonlit_reservoir", 1.8, 42.0, 112.0, 0.80, 3.3, [{"duration": 112, "amplitude": 0.86}, {"duration": 54, "amplitude": 0.66, "gap": 0.14}], 1.12, [1.08, 0.52, 0.29, 0.35, 0.37, 0.56, 0.75, 1.15, 1.35]), make("blue_catfish", "Blue Catfish", "moonlit_reservoir", 1.1, 50.0, 125.0, 0.88, 3.8, [{"duration": 155, "amplitude": 0.82}], 1.72, [1.48, 0.58, 0.31, 0.38, 0.31, 0.65, 0.62, 0.95, 1.42]), make("mahi_mahi", "Mahi-mahi", "bluewater_offshore", 3.0, 52.0, 130.0, 0.76, 2.7, [{"duration": 48, "amplitude": 0.82}, {"duration": 48, "amplitude": 0.82, "gap": 0.08}], 0.62, [0.74, 0.60, 0.29, 0.33, 0.41, 0.54, 0.9, 1.2, 1.35]), make("yellowfin_tuna", "Yellowfin Tuna", "bluewater_offshore", 1.35, 72.0, 180.0, 0.84, 3.9, [{"duration": 180, "amplitude": 1.0}, {"duration": 74, "amplitude": 0.78, "gap": 0.17}], 1.34, [1.10, 0.52, 0.29, 0.35, 0.37, 0.65, 0.65, 1.0, 1.7]), make("atlantic_sailfish", "Atlantic Sailfish", "bluewater_offshore", 0.72, 120.0, 240.0, 0.86, 4.2, [{"duration": 190, "amplitude": 1.0}, {"duration": 102, "amplitude": 0.90, "gap": 0.20}], 1.58, [1.12, 0.50, 0.30, 0.36, 0.36, 0.68, 0.45, 0.95, 1.85])]
