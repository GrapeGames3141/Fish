...
- The signed debug package is arm64-only with compressed native libraries and excludes non-runtime evidence/editor/demo material. Its export size and signing evidence must be recorded before any replacement install.
